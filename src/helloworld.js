...
class HelloWorld extends Component {
  ...
  render() {
    ...
    return  (
    <div style={{width: "100%",position: "fixed", zIndex: "1", paddingTop: "20px", backgroundColor: "white"}} >

    <h1><img src='assets/wsj-logo.svg' style={{width: "80%", display: "block", margin: "auto"}} /></h1>
<p style={{textAlign: "center", marginBottom: "-00px"}}>    {today}</p>
    </div>
    )
  }
};
